...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  override def mostRetweeted: Tweet =
    if (!right.isEmpty && elem.retweets < right.mostRetweeted.retweets) right mostRetweeted
    else if (!left.isEmpty && elem.retweets < left.mostRetweeted.retweets) left mostRetweeted
    else elem
